...
def main():
    ...
    # for Phytium FT2000+/64:
    # one core has 32KiB L1d, 32KiB L1i
    # one cluster by 4 cores has 2MiB L2
    # no l3
    ...
    socket = ProcessorHierarchyV3(
        flags=0,
    )
    pptt.items.append(socket)

    for i in range(16):
        cluster = ProcessorHierarchyV3(
            flags=0,
            parent=socket,
        )
